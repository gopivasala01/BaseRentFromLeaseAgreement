...
public class Georgia_Format2 
{
	...
	//public static void main(String[] args) throws Exception 
	{
	    ...
	    try
	    {
	    	PDFReader.proratedRentDate = text.substring(text.indexOf(PDFAppConfig.Georgia_Format2.proratedRentDate_Prior)+PDFAppConfig.Georgia_Format2.proratedRentDate_Prior.length()+1,text.indexOf(PDFAppConfig.Georgia_Format2.proratedRentDate_After)).trim();
	    ...
	    try
	    {
	    	PDFReader.proratedRent = text.substring(text.indexOf(PDFAppConfig.Georgia_Format2.proratedRent_Prior)+PDFAppConfig.Georgia_Format2.proratedRent_Prior.length()).split(" ")[0].trim();
