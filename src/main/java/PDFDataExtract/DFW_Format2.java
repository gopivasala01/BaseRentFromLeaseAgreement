...
public class DFW_Format2 
{
	...
	//public static void main(String[] args) throws Exception 
	{
	    ...
	    try
	    {
	    	String commensementRaw = text.substring(text.indexOf(PDFAppConfig.DFW_Format2.commensementDate_Prior)+PDFAppConfig.DFW_Format2.commensementDate_Prior.length()+1).trim();//,text.indexOf(PDFAppConfig.DFW_Format2.commensementDate_After)).trim();
	    ...
	    try
	    {
	    	String expirationDateRaw  = text.substring(text.indexOf(PDFAppConfig.DFW_Format2.expirationDate_Prior)+PDFAppConfig.DFW_Format2.expirationDate_Prior.length()).trim();//,text.indexOf(PDFAppConfig.DFW_Format2.expirationDate_After)).trim();
	    ...
	    try
	    {
	    	PDFReader.proratedRentDate = text.substring(text.indexOf(PDFAppConfig.DFW_Format2.proratedRentDate_Prior)+PDFAppConfig.DFW_Format2.proratedRentDate_Prior.length()+1,text.indexOf(PDFAppConfig.DFW_Format2.proratedRentDate_After)).trim();
	    ...
	    try
	    {
	    	PDFReader.proratedRent = text.substring(text.indexOf(PDFAppConfig.DFW_Format2.proratedRent_Prior)+PDFAppConfig.DFW_Format2.proratedRent_Prior.length()).split(" ")[0].trim();
