...
public class Boise_Format2 
{
	...
	//public static void main(String[] args) throws Exception 
	{
	    ...
	    try
	    {
	    	String commensementRaw = text.substring(text.indexOf(PDFAppConfig.Boise_Format2.commensementDate_Prior)+PDFAppConfig.Boise_Format2.commensementDate_Prior.length()+1).trim();//,text.indexOf(PDFAppConfig.Boise_Format2.commensementDate_After)).trim();
	    ...
	    try
	    {
	    	String expirationDateRaw  = text.substring(text.indexOf(PDFAppConfig.Boise_Format2.expirationDate_Prior)+PDFAppConfig.Boise_Format2.expirationDate_Prior.length()).trim();//,text.indexOf(PDFAppConfig.Boise_Format2.expirationDate_After)).trim();
	    ...
	    try
	    {
	    	PDFReader.proratedRentDate = text.substring(text.indexOf(PDFAppConfig.Boise_Format2.proratedRentDate_Prior)+PDFAppConfig.Boise_Format2.proratedRentDate_Prior.length()+1,text.indexOf(PDFAppConfig.Boise_Format2.proratedRentDate_After)).trim();
	    ...
	    try
	    {
	    	PDFReader.proratedRent = text.substring(text.indexOf(PDFAppConfig.Boise_Format2.proratedRent_Prior)+PDFAppConfig.Boise_Format2.proratedRent_Prior.length()).split(" ")[0].trim();
	    ...
	    try
	    {
	    	PDFReader.monthlyRent = text.substring(text.indexOf(PDFAppConfig.Boise_Format2.monthlyRent_Prior)+PDFAppConfig.Boise_Format2.monthlyRent_Prior.length()).split(" ")[0].trim();
	    	if(!PDFReader.monthlyRent.contains("."))
	    		PDFReader.monthlyRent = text.substring(text.indexOf(PDFAppConfig.Boise_Format2.monthlyRent_Prior2)+PDFAppConfig.Boise_Format2.monthlyRent_Prior2.length()).split(" ")[0].trim();
