...
{
	public static String commensementDate_Prior = "per month, beginning on";
	public static String commensementDate_After = " (the �Commencement Date�)";
	
	public static String expirationDate_Prior = "This agreement is intended to expire on";
	...
	public static String monthlyRent_Prior  = "Rent is due in advance on the FIRST day of each and every month, at $";
	...
	public static String lateChargePerDayFee = "ate charge equal to ";
	...
	public static String AB_serviceAnimal_typeWord_Prior = "Tenant has the following Service/Support Animal(s) on the Property until the above-referenced lease ends.";
	public static String AB_serviceAnimal_typeWord_After = "B. SERVICE/SUPPORT ANIMAL RULES";
	
	public static String monthlyRentAvailabilityCheck ="*Per the Landlord, Monthly Rent";
	...
	public static String AB_pet1Type_Prior = "Type:";
	public static String AB_pet1Type_After = "Breed:";
